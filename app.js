			...
			client.query(sqlStr1, function(err, result) {
				...
				for (var i=0;i<vidID.length;i++){
					...
					client.query(sqlStr, function(err, result2) {
						...
						output.push({'artist':result2.rows[0].artist,'fileLink':result2.rows[0].filelink,'genre':result2.rows[0].genre,'title':result2.rows[0].title,'plays':result2.rows[0].plays,'dates':result2.rows[0].dates});
